package com.toracoya.petstore.auth

import com.toracoya.petstore.auth.Authenticator.AuthenticationError
...
package object authenticator {
  def authenticatorService: ZIO[Authenticator, AuthenticationError, Authenticator.Service] =
